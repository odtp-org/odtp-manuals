...
!!! note
    it is very important to fill the odtp.yml file correctly as in the version v0.5.0 this file has become of operational importance:
    * it is is used to prefill parameters and ports
    * it imports metadata on the Component Version into ODTP
